...
var AddEventComponent = (function () {
    ...
    AddEventComponent.prototype.ngOnInit = function () {
        ...
        if (this.editMode) {
            ...
            this.newEvent = new event_class_1.Event("", "", "", "", null, null, "https://thumbs.dreamstime.com/t/people-hands-holding-colorful-straight-word-event-many-caucasian-letters-characters-building-isolated-english-white-54680491.jpg", 0, "", this.marker.latitude, this.marker.longitude, this.userId, []);
        }
    };
